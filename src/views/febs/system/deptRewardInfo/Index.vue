    ...
    <el-main>
      <div class="filter-container">
        <el-select v-model="userId" placeholder="代理商" clearable @change="initOrder()">
          <el-option v-for="item in agentLists" :key="item.userId" :label="item.userName" :value="item.userId" />
        </el-select>
      </div>
      ...
      <div class="pagination-container">
        <el-pagination background layout="total, sizes,prev, pager, next,jumper" :page-size="pageSize"
          :page-sizes="[5, 10, 15]" :total="total" @size-change="handleSizeChange"
    ...
    <el-dialog title="新增" :visible.sync="addDialogVisible">
      <el-form>
        ...
        <el-form-item label="分成比例">
          <el-input type="number" class="filter-item search-item" v-model="addForm.shareRatio"
            placeholder="分成比例"></el-input>
        </el-form-item>
      </el-form>
